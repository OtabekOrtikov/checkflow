// src/components/GridDepartmentTable.tsx
"use client";

import React from "react";
import type { Department } from "@/types/organization.t";
...
interface Props {
  ...
  onUpdate: (id: string, upd: Partial<Department>) => void;
  onDelete: (id: string) => void;
  onPin?: (id: string) => void;
}

export const GridDepartmentTable: React.FC<Props> = ({
  data,
  loading,
  page = 1,
  pageSize = 5,
  ...
  return (
    <div className="overflow-x-auto bg-white rounded-[20px] p-[20px] border border-(--gray-e6) flex flex-col gap-[10px]">
      ...
      >
        ...
        <div
          className="
            grid grid-cols-[2fr_2fr_1fr] items-center
